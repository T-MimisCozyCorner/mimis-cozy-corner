...
export default function App(){
  ...
  const create = async ()=>{
    ...
    try{
      ...
      if(data.success){ alert(`✅ Created ${selProd.name}! ID:${data.product_id}\n\nNow go to Printify → Publish → It will show at mimis-cozy-corner.printify.me`); window.open(`https://printify.com/app/store/1/products/${data.product_id}`,'_blank'); }
        ...
        <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.65)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:100,padding:"16px"}} onClick={()=>setSel(null)}>
          <div style={{background:"white",borderRadius:"20px",maxWidth:"520px",width:"100%",overflow:"hidden"}} onClick={e=>e.stopPropagation()}>
            ...
            <div style={{padding:"16px"}}>
              ...
              <p style={{fontSize:"11px",color:"#666",textAlign:"center",marginTop:"8px"}}>Creates → Publish in Printify → Shows at mimis-cozy-corner.printify.me + linked from mimiscozycorner.com</p>
