  ...
  return (
    <div style={{background:"#fffaf5", minHeight:"100vh", fontFamily:"system-ui"}}>
      <div style={{background:"white", borderBottom:"4px solid #a2006d", padding:"18px 16px", textAlign:"center"}}>
        <img src="/images/mimis-cozy-logo.png" alt="Mimi's Cozy Corner" style={{maxWidth:"600px", width:"100%", margin:"0 auto", display:"block"}} onError={(e:any)=>e.target.style.display="none"}/>
      ...
      <div style={{maxWidth:"1100px", margin:"0 auto", padding:"16px"}}>
        ...
        {showHousing && (
          <div style={{marginTop:"14px", background:"white", borderRadius:"12px", padding:"14px", border:"2px solid #0f5ca8"}}>
            ...
            <p style={{fontSize:"11px", color:"#555", margin:"0 0 10px"}}>Script: "Hi, my name is Tonya. I have a Housing Choice Voucher, have lived at my current residence for 10 years, and am looking for a long-term home for my family. Is the property still available and can I schedule a tour?"</p>
        ...
        <div style={{marginTop:"16px", background:"#111", color:"white", borderRadius:"12px", padding:"14px"}}>
          ...
          <div style={{fontSize:"11px", marginTop:"8px", lineHeight:"1.6", opacity:0.9}}>
            ...
            <div><b style={{color:"#10b981"}}>mimis-cozy-corner.printify.me</b> = 5 live products - Pop-up store</div>
          </div>
        </div>
      </div>
    </div>
